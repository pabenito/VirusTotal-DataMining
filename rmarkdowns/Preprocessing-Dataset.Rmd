...
df <- 
  ...
  select(
    ...
    -additional_info.exiftool.ZipBitFlag,
...
There are many columns which have same information of others, or they are simply useless.
Let's remove them.
...
- FileTypeExtension has same values as FileType
